# Simulate an Ethernet LAN using n nodes and set multiple traffic nodes and plot congestion window for different source and destination
...
# Use colors to differentiate traffics
...
# Plot congestion window graph using xgraph
...
# To plot graph over the x and y axis
...
# [optional to analyze the amount of drop removed packets in tr file]
...
# Set up TCP connection between n(0) and n(4)
...
# Set up TCP connection between n(1) and n(5)
